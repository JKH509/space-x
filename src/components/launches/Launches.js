...
const Launches = ( ) => {
  ...
  useEffect(() => {
    ...
    .map((launch) => {
      // <div className="row ">
      return (
        <div className="col-12 col-md-6  col-xl-4 mb-3 d-flex align-items-stretch " key={launch.id}>
          <div className="row cardBackground m-2 p-4 d-flex  flex-fill" key={launch.id}>

            <div className="col-3 patchDiv">
              <img className="patchImg" src={launch.links.patch.small} alt={launch.name} />
            </div>

            <div className="col-9 d-flex ">
              <div className="row">
                <h5 className="card-title ">{launch.name}{" "}{launch.id}</h5>
